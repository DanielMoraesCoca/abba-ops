...
| Partes da formação | **Base comum** (8 aulas, todo mundo da empresa faz) · **Trilhas de aprofundamento** por papel (Operacional 6, Gestor 5) · **Formação de Campeão** (8 aulas, quem quer que a área inteira use IA bem). Todas ABERTAS a qualquer participante, sem seleção, sem indicação e sem autorização. Nomeie assim em proposta, sala e portal | ✅ fixo (2026-08-26) |
