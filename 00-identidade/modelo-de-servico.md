# Modelo de Serviço — ABBA (canônico)

> Este é o frame oficial de como a ABBA entrega valor. Todo material comercial, proposta e conversa usa **estas 6 etapas**. Frames anteriores (4 estágios do plano v3.2; 5 serviços do contrato charter) são visões internas equivalentes — mapeamento no final.
...
```
1. DEGUSTAÇÃO          gratuita — análise por informação pública (site)
      ↓
...
4. TRANSFORMAÇÃO       capacitação híbrida: plataforma + presencial, todos os níveis
      ↓
5. MANUTENÇÃO          operação contínua, SLA, relatório mensal
      ↺
6. ALINHAMENTO         ritual permanente com a diretoria — os objetivos DELES dirigem
   (envolve todas as etapas — não é a última, é a constante)
```
...
- **Plataforma ABBA:** trilhas progressivas em 4 níveis (Explorador → Praticante → Especialista → Arquiteto), videoaulas, desafios práticos avaliados por IA, a Iris (guia de IA em português) e a **Bússola** — a pergunta instalada em cada colaborador: *o que posso **parar** de fazer (a IA faz)? o que posso **começar** a fazer (a IA permite)? o que **ainda preciso** fazer?*
...
| 6 etapas (canônico) | 4 estágios (v3.2) | 5 serviços (charter) |
|---|---|---|
| 1. Degustação | (pré-funil) | — |
| 2. Avaliação profunda | Assessment | Diagnóstico |
| 3. Construção | Prototypes + Deployment | Implantação |
| 4. Transformação | (atravessa os estágios — "tecido conectivo") | Capacitação |
| 5. Manutenção | Managed Services | Operação |
| 6. Alinhamento | (governança do engajamento) | Governança |

## Ligações
Jornada operacional completa: [`02-jornada-do-cliente/`](../02-jornada-do-cliente/README.md) · Posicionamento e vocabulário: [posicionamento](posicionamento.md) · Preços: [tabela](../03-comercial/tabela-de-precos.md)
