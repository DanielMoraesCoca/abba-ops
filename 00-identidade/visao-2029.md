# Visão 2029 — a ABBA vista do topo da montanha

> **Camada:** identidade. Este documento não descreve o que fazemos esta semana ([plano de ação](../05-interno/plano-de-acao.md)) nem o que vendemos hoje ([modelo de serviço](modelo-de-servico.md), [posicionamento](posicionamento.md)). Descreve **onde isso chega, contra quem, e o que não pode ser negociado no caminho**. Releia antes de cada decisão grande — principalmente antes das portas de 1 via.
>
> **Origem:** pedido do sócio (2026-08-01): *"preciso de uma perspectiva da empresa como se estivesse no topo de uma montanha... creio que mesmo com essas mudanças, o nosso serviço ainda não chegou naquele estado onde é uma necessidade DISRUPTIVA."* A intuição está certa, e a §2 explica exatamente por quê.
>
> **Cenário-base escolhido pelos sócios:** consultoria com ativo próprio — crescemos por profundidade, não por número de pessoas. As alternativas (virar produto/SaaS; boutique de altíssimo ticket) continuam registradas em [apostas futuras](apostas-futuras.md).
>
> **Horizonte:** 2026–2029. Revisão obrigatória a cada 6 meses ou quando qualquer um dos relógios da §7 disparar.

---

## 1. A paisagem: o que está acontecendo lá fora

### 1.1 A consultoria não está morrendo — a unidade de cobrança está

A demanda cresce: consultoria de tecnologia passa de **US$ 400 bi em 2026** (Source Global Research) e **81% dos compradores pretendem aumentar** a dependência de consultores. Mas o modelo que sustentava a indústria está sendo desmontado por dentro:

- **McKinsey já tem ~25% dos honorários atrelados a resultado**, não a horas. Seu assistente interno roda mais de 500 mil prompts/mês com relatos de até 30% de economia de tempo — o que torna a hora bilhável cada vez mais difícil de justificar para o próprio cliente.
- O CEO global da McKinsey declarou (jan/2026) uma força de trabalho de 60 mil pessoas **das quais 20–25 mil são agentes de IA**, com expectativa de paridade humano/agente até o fim de 2026. Eram ~3.000 agentes em 2024.
...
> **A conclusão desconfortável e necessária: memória virou commodity.** Um engenheiro pluga memória persistente numa tarde. Em 24 meses ela será um checkbox incluído na licença do M365 que o cliente já paga.

**Portanto: a ABBA não deve se posicionar como "quem constrói o cérebro da empresa".** Seríamos atropelados por um SKU.
...
## 2. Por que ainda não somos uma necessidade disruptiva

A intuição do sócio está correta. Aqui está o mecanismo, sem consolo.

### 2.1 A diferença entre vitamina e analgésico é econômica, não retórica

| | Analgésico | Vitamina |
|---|---|---|
| Retorno do custo de aquisição | **< 9 meses** | 18+ meses |
| Sensibilidade a preço | Baixa | Alta |
| Desconto | Baixo | Alto |
| O que acontece ao cancelar | **Sangra** | Não dói |

E o dado que fecha o diagnóstico do nosso mercado: **72% das empresas brasileiras estão em estágio inicial de IA e o retorno percebido leva em média 28 meses** — contra os **4 a 8 meses de payback** que o comprador brasileiro exige. IA "para produtividade" é vitamina clássica.
...
> **Se a ABBA sumisse amanhã, o cliente perderia (a) uma agenda, ou (b) uma capacidade operacional que ele não reconstrói em menos de 6 meses?**

Se for (a), o preço será comprimido até o custo. Se for (b), somos infraestrutura.

**O cérebro é a semente de (b) — mas hoje ele é ferramenta NOSSA.** Ele nos ajuda a atender melhor; o cliente não depende dele. A virada acontece quando o cérebro deixa de ser a nossa ferramenta de trabalho e vira **o sistema onde as decisões de IA do cliente nascem, são registradas e são provadas** — com a trilha que a diretoria dele precisa para governar e que o regulador vai exigir.

### 2.3 Os seis mecanismos que fazem a virada
...
### 2.4 O que precisa mudar para chegar lá
...
## 3. Onde geramos valor — as três camadas
...
- **Curvas de tenure** (`abba brain benchmark`) — o artefato publicável que ninguém tem
- **Playbooks procedurais** nascidos só de vitórias medidas

> **Regra de investimento:** toda hora gasta deve, quando possível, depositar na Camada 3. Uma hora que só entrega Camada 2 é receita; uma hora que deposita na Camada 3 é **patrimônio**. A diferença entre uma consultoria avaliada a 0,5× receita e uma avaliada a 4× **é literalmente a existência de IP que funciona sem os fundadores**.

---

## 4. O fosso — e seu prazo de validade
...
Nem "temos memória" (commodity), nem "temos método" (todo mundo diz). O defensável é a **interseção**, e ela tem quatro lados que só existem juntos:

**operador responsável** (construímos e mantemos, não só recomendamos) **×** **diário de resultados medidos** (baseline → medido → veredicto, com nome de quem assinou) **×** **assinatura humana em toda saída** (o modelo centauro, que o PL 2338 vai transformar de virtude em requisito) **×** **deleção comprovável** (certificado de resíduo zero — artefato LGPD que nenhum concorrente tem).

Nenhum dos quatro é defensável sozinho. Os quatro juntos, por cliente, acumulando por anos, não são reconstituíveis por quem chegou depois.

### 4.3 O relógio

A janela para converter reputação em ativo proprietário é de **24 a 36 meses**, e ela fecha pelos dois lados ao mesmo tempo:

- **Por cima:** a OpenAI capitalizou uma subsidiária de serviços com >US$ 4 bi e está descendo mercado; a Accenture comprou a Faculty e comprará mais; o Palantir cresce 85% ao ano provando que o modelo embarcado ganha; a CI&T já desce via canal com camada proprietária.
- **Por baixo:** as agências de automação entregam em dias por R$ 8–25 mil e **treinam o comprador brasileiro a achar que esse é o preço da IA**.

**Quando o Work IQ e o Gemini Enterprise chegarem em português com conector para ERP brasileiro, a pergunta "por que preciso da ABBA?" fica muito mais difícil de responder.** Até lá, ou somos donos de algo que ninguém reconstrói, ou somos mais uma firma de dois sócios vendendo horas caras num mercado onde a hora deixou de ser a unidade de valor.

---

## 5. Ventos regulatórios até 2030 — onde "IA auditável" vira lei

| Quando | O quê | O que significa para nós |
|---|---|---|
| **Já, 2026** | **ANPD: 75 ações de fiscalização no biênio 2026–27, 20 delas sobre IA.** Critérios: transparência, viés, segurança, Art. 20 da LGPD (decisões automatizadas) | **A exposição legal do cliente é hoje, não em 2029.** A ANPD não está esperando o PL 2338 |
| **03/08/2026** | Campos de IBS e CBS passam a ser **validados em produção** na NF-e | Marco mais urgente do calendário brasileiro. Toda empresa mexe no ERP, obrigatoriamente |
| **Set/2026** | Prazo de decisão sobre permanência ou migração de regime tributário | Janela de conversa com o CFO |
| **2026–2027** | **PL 2338** (aprovado no Senado em dez/2024, em tramitação na Câmara) | **Avaliação de Impacto Algorítmico obrigatória** para alto risco; rastreabilidade dos dados; direito a explicação e contestação (exige **revisão humana**); multa de até **2% do faturamento, teto de R$ 50 mi**. Vigência plena esperada em **2028–2029** (vacatio de 18–24 meses, como na LGPD) |
| **02/08/2027** | **EU AI Act** em aplicação plena; alto risco adiado para dez/2027 | Chega ao exportador brasileiro **como cláusula contratual antes de chegar como lei**. Multas até 7% do faturamento global |
| **2027** | CBS plena (~8,8%), PIS/Cofins extintos | |
| **2029–2032** | Convivência dos dois sistemas tributários | Quatro anos de complexidade dobrada |

**A convergência é o ponto:** entre 2026 e 2029, **"IA auditável e comprovável" deixa de ser sofisticação e vira requisito legal.** E o passivo já existe sem estar contabilizado: **63% das empresas brasileiras não têm política de IA** e **47% dos profissionais usam IA sem aprovação oficial**.

**Cada peça que construímos por convicção técnica vira, nesse cenário, um artefato de conformidade:** o gate de humano nomeado é a revisão humana do PL 2338; a linha do tempo bitemporal é a rastreabilidade; o certificado de deleção é a prova de atendimento ao titular; o diário de decisões é a documentação de atuação diligente. **Construímos a coisa certa antes de saber que seria exigida.**

---

## 6. Os inegociáveis

Regras que não se vendem — nem por um contrato grande, nem por um cliente importante. Cada uma com o custo real de quebrá-la.

| # | Inegociável | Se quebrarmos |
|---|---|---|
...
## 7. O caminho — sequência, gatilhos e pontos de não-retorno
...
- **Lançar o Resgate de IA** ([to-do aprovado](../05-interno/plano-implementacao-conselheiro.md) §12)
...
- Comunidade de campeões entre clientes (aposta 4), se os gatilhos dispararem
- *Métrica que importa:* **um cliente que tenta sair descobre que precisa de 6 meses para reconstruir o que perde**

### Pontos de não-retorno (portas de 1 via — dormir sobre elas)
- Contratar o primeiro funcionário (muda a estrutura de custo e a zona de escala)
- Publicar garantia de resultado ([E6](../05-interno/registro-de-decisoes.md) — ainda não ativada)
- Vender o cérebro como produto avulso (muda a identidade consulting-first)
- Aceitar um cliente que passe de ~30% da receita **sem plano de diluição com data**

### As lacunas que este documento não resolve
O [plano de negócio](plano-de-negocio.md) tem metas do ano 1 em branco (`{{VALOR}}`, `{{DATA}}`, `{{N}}`) desde julho. Elas não são preenchidas aqui de propósito: **número de meta é decisão de sócio, não de consultor.** Mas ficam duas âncoras da pesquisa para calibrar a conversa: cinco clientes de retainer bastam para estabilizar dois sócios; e o ticket de conforto do mid-market brasileiro é **R$ 30–150 mil por fase, com prova de valor em 60–90 dias**.
...
**1. O fosso exige escala; a escala destrói a margem; e o meio-termo mata.**
Dados entre clientes exigem volume. Dois sócios não geram volume. Contratar gera volume e mata a margem — a Faculty provou. E o IP que funciona sem vocês é exatamente o IP que vocês não têm tempo de construir enquanto entregam. **Cada hora de entrega é uma hora não investida na única coisa que separa 0,5× de 4×. E não existe momento futuro em que essa escolha fica mais fácil.**

**2. A memória vira commodity antes de conseguirmos cobrar por ela.**
Se nos posicionarmos como "quem constrói o cérebro", seremos atropelados por um SKU. Se nos posicionarmos como "quem cura o que entra e responde pelo que sai", temos fosso — mas vendemos algo **muito mais difícil de explicar e precificar**, que o comprador brasileiro ainda não sabe que precisa. **Estamos certos cedo demais, e estar certo cedo demais é comercialmente indistinguível de estar errado.**

**3. Precisamos ser analgésico, mas o analgésico com data marcada não é a IA.**
...
Estudos internos que este documento pressupõe e não repete: [mercado de ofertas](../05-interno/estudo-mercado-ofertas.md) · [big techs e o cérebro de empresa](../05-interno/estudo-big-techs-company-brain.md) · [memória agêntica](../05-interno/estudo-memoria-agentica.md) · [IA financeira](../05-interno/estudo-ia-financeira.md) · [arquitetura do cérebro](../05-interno/arquitetura-cerebro-conselheiro.md).
