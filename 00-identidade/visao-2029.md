...
4. **Compressão de ciclo como produto.** O bootcamp de 5 dias da Palantir: **1.300 execuções, ~75% de conversão**, ciclo de venda de 12–18 meses comprimido para semanas. O que converte não é a promessa — é o cliente **ver o próprio dado funcionando** antes de assinar. Para dois sócios, é o único modelo de venda com custo de aquisição viável. **Nosso Assessment gratuito gratuita já é isso e ainda não a tratamos assim.**
