...
2. Sugestão de equilíbrio: cada sócio é dono de 2–3 chapéus, e suplente dos outros (bus factor).
3. Troca de dono é legítima e barata: registrar a troca e atualizar a matriz.
4. O checklist semanal de cada setor é percorrido na **reunião semanal de sócios** ([comunicação](../05-interno/comunicacao.md)) — 5 min por setor.

## Gatilhos de contratação (quando o chapéu vira gente)
