...
| CrewAI (stack externa) | Construção dos agentes de cliente (estágio 07) + acesso de quem conclui a formação (as 27 aulas e os 15 desafios exigíveis) | Conta/via de contratação a definir (Enterprise vs. self-host) |
