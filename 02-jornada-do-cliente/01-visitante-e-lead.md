...
## Entrada
Alguém demonstrou interesse: formulário do site (quando existir), mensagem no LinkedIn, indicação, contato em evento, e-mail frio respondido.

## Checklist

- [ ] Registrar o lead: criar pasta `01 Comercial/Leads/AAAA-MM NomeEmpresa/` no Drive com nota de origem (quem, quando, por quê)
- [ ] Qualificação mínima (pesquisa de 15 min): porte (nº colaboradores), setor, sinais de dor com IA (notícias, vagas, posts), quem é o provável decisor
...
- [ ] Saída da call: **agendar a apresentação do assessment gratuito — que chegará FEITA** (decisão 2026-07-27: nunca "oferecer"; chegamos com o [Assessment gratuito](../03-comercial/assessment-gratuito.md) pronto) ([estágio 02](02-diagnostico-gratuito.md)) — ou proposta direta se o lead já chegou quente ([estágio 03](03-proposta.md))
...
Drive `01 Comercial/Leads/` · LinkedIn · [pautas](../03-comercial/pautas-de-reuniao.md) · [e-mails](../03-comercial/emails-follow-up.md)
