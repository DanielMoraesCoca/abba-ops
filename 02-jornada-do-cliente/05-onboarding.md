...
## Entrada
Contrato assinado, primeira parcela cobrada, kickoff agendado.
...
- [ ] Engajamento criado nas ferramentas internas (assessment-brain: cliente + engajamento; portal: tenant)
- [ ] Deck de kickoff preparado a partir do [roteiro](../04-entrega/kickoff-roteiro.md)
...
**Depois**
- [ ] Ata do kickoff no Drive em 24h + resumo por e-mail ao patrocinador
- [ ] Convites de pré-trabalho disparados (quando aplicável)

## Saída
Kickoff realizado, acessos funcionando, métricas acordadas, cadência agendada → [06-avaliacao-profunda](06-avaliacao-profunda.md) (ou direto ao estágio contratado, se produto de entrada).

## Ferramentas e templates
Roteiro de kickoff · assessment-brain (CLI: criar cliente/engajamento) · portal ABBA (tenant + contas) · Drive (`02 Onboarding/`)
