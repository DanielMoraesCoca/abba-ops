...
- [ ] Graduação: certificados + cerimônia na sessão de encerramento

## Saída
Equipe operando com os agentes no dia a dia + campeões formados + métricas de adoção no alvo → alimenta [09-manutencao](09-manutencao.md) e o [pacote de handover do estágio 11](11-renovacao-e-encerramento.md).
