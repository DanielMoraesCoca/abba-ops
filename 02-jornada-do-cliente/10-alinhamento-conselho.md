...
## Entrada
Data trimestral chegando (agendar sempre a próxima ao fim da atual) ou etapa do programa concluída.
...
## Saída
Plano realinhado e registrado. Sinais de expansão → Comercial. Sinais de risco de churn → plano de recuperação antes da renovação.

## Ferramentas e templates
[Pauta do conselho](../04-entrega/pauta-conselho.md) · relatórios das ferramentas · Drive `07 Conselho/`
