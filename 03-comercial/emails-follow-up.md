...
> [Nome],
>
> Pergunta rápida: quando a [Empresa] pilotou IA, a adoção se manteve depois que o piloto acabou?
>
...
>
> Três coisas que valem seu tempo: [bullet 1 — oportunidade mais forte] · [bullet 2 — hipótese provocativa] · [bullet 3 — pergunta aberta].
>
> Lembrando o limite honesto: isso foi feito de fora. A avaliação profunda entrevista do conselho à linha de frente e quantifica cada oportunidade em reais.
>
...
> [Nome], contrato assinado — obrigado pela confiança.
>
> Próximos passos: (1) kickoff em [data, já agendada ou a agendar em até 10 dias úteis]; (2) até lá, precisamos de [lista curta: patrocinador confirmado, canal de comunicação, lista de participantes]; (3) sua nota fiscal da primeira parcela segue em até 2 dias úteis.
>
> A partir de agora vocês têm nosso compromisso de resposta em até 1 dia útil.
