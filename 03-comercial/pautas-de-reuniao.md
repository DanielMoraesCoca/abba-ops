# Pautas de Reunião Comercial — ABBA

> Quatro pautas prontas, da primeira conversa ao kickoff. Duração-alvo no título. Antes de qualquer reunião: reler o [posicionamento](../00-identidade/posicionamento.md) — vocabulário certo, sempre.

## 1. Primeira call de descoberta (30 min)

**Objetivo:** entender a dor, qualificar, e sair com um próximo passo agendado. NÃO é apresentação de proposta.
...
| 22–28 | Próximo passo | **Nunca "oferecer" o assessment gratuito — chegar com ela FEITA** (decisão 2026-07-27): agendar a apresentação do [Assessment gratuito](assessment-gratuito.md) já pronto, OU o produto de entrada adequado: dor difusa → Workshop Shadow AI · decisão de investimento → Avaliação de Prontidão · risco/compliance → Sprint LGPD · **já tem IA rodando → Conselheiro de IA** |
...
## 2. Apresentação de degustação/diagnóstico gratuito (45 min)

**Objetivo:** entregar valor real de graça, demonstrar o método, e converter para produto pago.

1. (5) **Abrir pela primeira página: o Assessment gratuito** — a faixa em R$, o vetor, as 3 premissas com fonte. Reenquadrar: "isto foi feito só com informação pública — imagine com os dados de dentro"
...
**Objetivo:** assinar sem corroer margem.

- Regras (da [metodologia de precificação](precificacao-metodologia.md)): desconto só com contrapartida (charter — Anexo III do contrato; prazo de pagamento menor; escopo reduzido) · nunca desconto por pressão sem troca · abaixo do preço mínimo da planilha = não vender
- Checklist de saída: valor final e condição de pagamento · escopo fechado (Anexo I) · patrocinador nomeado · data de kickoff · quem assina, e até quando
- **Depois:** contrato em até 2 dias úteis ([processo do estágio 04](../02-jornada-do-cliente/04-contrato.md))
