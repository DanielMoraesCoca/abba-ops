...
Você está aqui porque uma destas três situações se aplica:
...
**Semana 0 (antes do relógio começar)**
- Call de kickoff com patrocinador + 2–3 lideranças (1 hora)
- Perfil do engajamento criado na plataforma ABBA
- Convites de pré-trabalho enviados aos participantes selecionados
- Composição dos níveis confirmada (quantos executivos, gestores, operadores)
...
- Debrief de 60 min com o patrocinador
- Decisão de transição: continuar no programa completo, adiar 3–6 meses, ou encerrar com o relatório

## 5. O que o Relatório de Avaliação contém

1. Capa + contexto do engajamento
2. Pontuação de prontidão + abertura nas 5 dimensões
3. O que o seu time disse (agregados anonimizados do pré-trabalho)
4. Portfólio de oportunidades: top 10–20 casos de uso, ranqueados
5. Caminho recomendado: os 3 agentes que construiríamos primeiro, com justificativa
6. Decisões de governança capturadas + decisões ainda necessárias
7. Resultados das pesquisas: variância executivo / gestor / operacional
8. Próximos passos: continuar / adiar / encerrar, com custos e prazos específicos

Cada tabela e gráfico deriva de dados reais que o seu time registrou. Você pode pedir para ver os insumos por trás de qualquer afirmação.
...
**Faturamento:** 50% na assinatura, 50% em até 10 dias úteis após o debrief.
...
- Não é implantação de agentes (fase de construção do programa completo)
- Não é treinamento da equipe (a avaliação mede alfabetização; não a eleva)
- Não é certificação de compliance ([Sprint LGPD](proposta-sprint-lgpd.md))
- Não é seleção de fornecedores (recomendamos agentes que nós construiríamos; não avaliamos terceiros por você)

## 10. Próximos passos

1. Assinar esta proposta · 2. Agendar o kickoff da Semana 0 · 3. Confirmar composição dos níveis

Dúvidas: {{NOME_FACILITADOR}}, {{EMAIL_FACILITADOR}}.

## 11. Termos

- **Confidencialidade:** todos os artefatos produzidos são propriedade sua. A ABBA retém cópia por 24 meses. Não publicamos estudos de caso sem consentimento escrito (acordo separado).
- **Anonimato do pré-trabalho:** respostas individuais são insumos confidenciais; o relatório agrega. Transcrições brutas não são compartilhadas, exceto ao patrocinador nomeado, sob solicitação.
- **Cancelamento:** ≥10 dias úteis antes do kickoff: reembolso integral menos {{TAXA_COORDENACAO}}; <10 dias: 50%; após o kickoff: 100%.
- **Não incluso:** deslocamento fora da região metropolitana de {{CIDADE_BASE}}, coffee break, revisão jurídica especializada além do ajuste opcional.
- **Dados:** tratados conforme a LGPD; a ABBA atua como Operadora sob instruções do Cliente. **A ABBA não treina modelos com dados de clientes.**
