...
- Patrocinador com assento na diretoria (o ritual acontece NA reunião de diretoria, não em paralelo)
- Acesso às propostas de fornecedores de IA recebidas (para a arbitragem)
- Os objetivos declarados — e a franqueza de atualizá-los quando mudarem

## 5. Termos essenciais (além dos [termos-padrão](contrato-sow-esqueleto.md))

- **Contrato de 12 meses** · fatura mensal · reajuste IPCA · saída com aviso de 60 dias
- **PI:** pareceres, roadmaps e frameworks de governança produzidos são do cliente; o método é da ABBA
- **Não inclui:** execução de projetos (mini-ciclo/programa cotados à parte, com crédito de 1 mês do retainer), suporte técnico (contrato de manutenção), parecer jurídico formal ou representação perante a ANPD
- **Independência:** a ABBA não revende nem comissiona fornecedores — a arbitragem não tem conflito de interesse (é cláusula, não promessa)
- Cliente pode gravar/circular os pareceres internamente à vontade — são dele
