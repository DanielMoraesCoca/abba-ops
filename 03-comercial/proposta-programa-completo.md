...
**R$ 185.000** (faixa R$ 165–240 mil por porte e escopo — [tabela v1](tabela-de-precos.md)) — 30/30/40 por marco (assinatura / protótipo validado / go-live) ou mensalizado. Serviços gerenciados: **R$ 9.500/mês** após o go-live *(na tabela v2, a continuidade passa a 3 camadas — Operação/Evolução/Estratégia, esta última com [Conselheiro de IA](conselheiro-de-ia.md) embutido; preços em [rascunho](tabela-de-precos.md))*. Crédito de 100% de produto de entrada contratado nos últimos 90 dias.
