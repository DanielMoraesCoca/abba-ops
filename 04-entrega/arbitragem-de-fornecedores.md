# Arbitragem de Fornecedores — processo do entregável

> **Camada:** processo. **O documento do cliente é o modelo Word:** [`../08-materiais/modelos/arbitragem-fornecedores-modelo.docx`](../08-materiais/modelos/arbitragem-fornecedores-modelo.docx). É o entregável-assinatura do [Conselheiro de IA](../03-comercial/conselheiro-de-ia.md) — o rastro de valor por escrito que justifica cada renovação.

## Gatilho e prazo

Cliente recebe proposta/abordagem de fornecedor de IA → encaminha para a ABBA → **parecer por escrito em ≤ 5 dias úteis** (prazo é promessa de contrato; estourou → avisar antes com nova data, nunca silêncio). Cota conforme formato: Trimestral = 2/trimestre · Mensal = ilimitado.
...
## Métrica do entregável

Prazo cumprido (≤5 dias úteis) em 100% dos pareceres · decisão do cliente registrada em 100% · economia/risco evitado estimado por parecer (número para o ritual do conselho e para a renovação).
