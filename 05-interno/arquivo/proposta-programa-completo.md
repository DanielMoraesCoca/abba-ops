...
> **Uso interno:** conteúdo de referência da proposta-herói. O modelo Word mestre (`proposta-comercial-modelo.docx`) foi **retirado na V5** (ver nota acima) — este markdown é a fonte da estrutura e do texto. Baseada na primeira proposta real emitida (ref ABBA-2026-001, jun/2026; decisão no [registro](../registro-de-decisoes.md)). Preencher `{{CAMPOS}}`, preço pela [tabela vigente](../../03-comercial/tabela-de-precos.md), personalizar seções 1–2 com achados da degustação, congelar PDF no Drive, registrar a ref sequencial (`ABBA-AAAA-NNN`).
...
- **4.6 Conselheiro de IA (a criação nova):** a cadeira do estrategista de IA do lado do cliente da mesa — presença na diretoria, roadmap vivo, arbitragem de fornecedores ([produto](../../03-comercial/conselheiro-de-ia.md)); embutido na camada Estratégia ou contratável avulso.
...
**R$ 260.000** (jornada completa; faixa R$ 220–320 mil por porte e escopo — [tabela v2](../../03-comercial/tabela-de-precos.md), a construção dimensionada pela [calculadora](../../06-ferramentas/calculadora-construcao.md)) — 30/30/40 por marco (assinatura / protótipos validados / go-live). Serviços gerenciados após o go-live: **R$ 9.500/mês** (camada Evolução, até 2 soluções; 3 camadas no [SLA](../../04-entrega/sla-manutencao.md), a Estratégia com [Conselheiro de IA](../../03-comercial/conselheiro-de-ia.md) embutido). Workshop contratado nos últimos 90 dias credita 100% no Assessment.
