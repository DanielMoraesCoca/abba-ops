...
| # | Item | Tempo | Como conduzir |
|---|---|---|---|
| 0 | **Saúde societária** | 2 min | Um pergunta ao outro: *"algo entre nós precisa de conversa?"* Sim → vira o primeiro assunto, sem pressa; a pauta espera. Não → segue |
| 1 | **Funil (métricas de INPUT)** | 15 min | Preencher a linha da semana no log abaixo, comparar com a meta, decidir UMA correção se houver desvio |
| 2 | **Engajamentos ativos** | 15 min | Por engajamento: no prazo? bloqueio? próxima entrega? |
...
| 6 | **Pendências abertas** | 5 min | Tabela de pendências do registro — o que destravou? quem cobra o quê? Enquanto abertas, cobrar nominalmente as **P1–P3 do assessment web** (site no repo, gating, captura de e-mail — dono: Pedro, [contrato de fronteira](../06-ferramentas/contrato-fronteira-gratuito-pago.md)) |
...
Metas: contatos ≥ {{10}}/sem · análises no prazo = 100% · reações a preço registradas = 100% · padrões: >0 em semana com encerramento.

| Semana | Contatos novos | Análises entregues ≤5du | Reações a preço registradas | T2 realizados | Propostas enviadas | Padrões novos no vault | Porta registrada? | 1 correção da semana |
|---|---|---|---|---|---|---|---|---|
| {{2026-W31}} | | | | | | | | |
| {{2026-W32}} | | | | | | | | |
| {{2026-W33}} | | | | | | | | |
...
Contato→aceite baixo = mensagem/alvo errado · análise→proposta baixo = T2 (ensaiar de novo) · proposta→contrato baixo = preço/âncora (ver reações registradas) · tudo baixo = cadência (item 1 da semana seguinte vira o único assunto).
