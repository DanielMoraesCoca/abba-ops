...
from .gates import triagem_red_flags
from .tools.obrigacoes import montar_pacote_obrigacoes, projetar_cenarios
from .tools.rag_corpus import RagCorpusTool
...
class PatrimonioFlow(Flow[S.EstadoCaso]):
    ...
    def crew_analise(self):
        from .crews.analise_crew import AnaliseCrew
    ...
    def crew_desenho(self):
        from .crews.desenho_crew import DesenhoCrew
    ...
    def crew_redacao(self):
        from .crews.redacao_crew import RedacaoCrew
