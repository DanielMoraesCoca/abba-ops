...
| **O portal entre as aulas — a academia diária (Currículo v3, 23/08/2026, CONTENT-16 no portal):** Prática de Hoje na home (uma ação de 2–5 min/dia), Biblioteca de Pedidos (40 pedidos por área, todo cartão termina em conferência), academia curta (drills de caça ao erro, Prompt Golf, cenários de decisão em texto), Boletim semanal (estudo curto na voz da casa, publicação agendada) e Minhas Ferramentas (o método escrito da pessoa, guardado e editável). **Fala pronta: "não é curso que acaba — é academia que a pessoa frequenta: todo dia o portal propõe uma prática de dois a cinco minutos no trabalho real dela".** Nada disso depende de vídeo — completo por desenho | | |
