...
|---|---|---|
| Uma formação em pt-BR com desafios avaliados pela Rubrica ABBA, Bússola e Iris (guia em português): **27 aulas escritas e no portal, e UMA formação só, a mesma para todo mundo: base comum (8), aplicação no trabalho (11) e Formação de Campeão (8). Não há trilha por cargo (revogadas em 02/09)** | **Vídeos: são NOSSOS (decisão CONTENT-13, 19/08/2026: revoga o modelo de licenciar terceiros).** Roteiros word-for-word prontos: **14 de 27** (base comum 8 + as 6 primeiras de aplicação; faltam as 5 últimas de aplicação e as 8 da Formação de Campeão); gravação pelos fundadores em lotes (aulas 3, 4 e 1 primeiro). Até gravar, a aula roda em 4 blocos: **prometer "aulas com prática avaliada"; NUNCA prometer biblioteca de vídeo com data** | SSO corporativo / requisitos de procurement enterprise (autenticação interina: R3) |
| Acesso individual por colaborador, progresso e adoção visíveis ao patrocinador | Fases 2–4: estrutura pronta, conteúdo produzido sob demanda do 1º cliente: prometer "conteúdo para a área do cliente", nunca "catálogo completo" | Fórum aberto entre clientes **antes do 3º cliente**: a rede existe em plano e o mecanismo está construído, mas não se promete data ([ecossistema](../00-identidade/ecossistema.md)) |
| Pré-trabalho da avaliação (reflexões, mapas de fluxo, Bússola) | **A escada de 4 níveis foi REVOGADA em 26/08** (P7 superado) e removida do portal nos blocos G1/G2. Não descrever pessoas como "Explorador/Praticante/Especialista/Arquiteto" em nenhum material: os nomes sobrevivem só como vocabulário de banco. Nomeie as PARTES: base comum · aplicação no trabalho · Formação de Campeão. **As trilhas por papel (Operacional, Gestor) também foram revogadas, em 02/09:** não descrever a formação como bifurcada por cargo em material nenhum | Marketplace de agentes |
| **Aplicação corroborada, com máquina (G1d, 29/08):** o portal mede **5 sinais** por pessoa (aulas da formação · desafios exigíveis · Bússolas visíveis ao gestor · **aplicou**: compromisso vivo aos 30 dias com evidência · **ajudou**: colega registrou o reconhecimento) e o **gestor corrobora** em `/manager/cohort/[pessoa]`, olhando junto a prova de trabalho (capstone com as 4 notas da Rubrica + Primeira Vitória) e os marcos d30/d60/d90. É essa corroboração que entra no relatório de 90 dias. **Não há promoção de nível**: a máquina que promovia foi removida em 26/08. Tela de graduação do facilitador (`/admin/graduacao`) com o portão **base comum 8/8 + ≥6/8 drills** por pessoa e **emissão em lote na cerimônia** da credencial da base: sem planilha paralela; credencial verificável **em pt-BR de ponta a ponta** e sem índice de fluência no artefato público | | |
