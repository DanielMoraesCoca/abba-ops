...
| **Escada e graduação com máquina (B2, 25/08; afinada na 2ª reauditoria do mesmo dia):** caminho P→S medido no portal em **6 sinais** (concluiu as aulas E os desafios da trilha do papel · aplicou com evidência viva aos 30 dias · um colega registrou a ajuda · ≥14 dias no nível · ≥3 Bússolas visíveis ao gestor) — o portal mede, o **gestor decide**, doutrina do patrocínio instrumentado; tela de graduação do facilitador (`/admin/graduacao`) com o portão **Fundação 8/8 + ≥6/8 drills** por pessoa e **emissão em lote na cerimônia da credencial de FUNDAÇÃO** (o nível que o portão prova; níveis acima saem pela emissão individual com as portas próprias) — sem planilha paralela; credencial verificável **em pt-BR de ponta a ponta** (selo "Fundação em IA" E a página pública /verify), sem índice de fluência no artefato público — inclusive nos tokens antigos, que deixaram de exibi-lo | | |
