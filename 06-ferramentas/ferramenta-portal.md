...
| **Escada e graduação com máquina (B2, 25/08):** caminho P→S medido no portal (concluiu a trilha + aplicou com evidência de 30 dias + um colega registrou a ajuda — o portal mede, o **gestor decide**, doutrina do patrocínio instrumentado); tela de graduação do facilitador (`/admin/graduacao`) com o portão **≥6/8 drills** por pessoa e **emissão de credenciais em lote na cerimônia** — sem planilha paralela; credencial verificável **em pt-BR** ("Fundação em IA"…), só emitida com o nível CONCLUÍDO (Fundação exige 8/8 aulas), sem índice de fluência no artefato público | | |
