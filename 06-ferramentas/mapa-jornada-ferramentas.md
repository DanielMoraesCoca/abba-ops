...
| 08 Capacitação | Portal (trilhas, desafios, Bússola, Iris, admin) | Funcional | 8 lições Foundation com **vídeos pendentes** · níveis Praticante+ sem conteúdo (fazer sob demanda do 1º cliente) · revisão pt-BR nativa pendente |
...
**As três lacunas que mais importam:** (1) validação com dados reais — resolvida PELO primeiro engajamento; (2) conta CrewAI — decisão Enterprise vs. self-host pendente; (3) vídeos da capacitação — priorizar a trilha do departamento do 1º cliente apenas. (O site importa para escalar aquisição, não para atender o 1º cliente.)
