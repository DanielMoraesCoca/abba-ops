...
| 02 Degustação | **assessment web** (`assessment.abbaservices.com.br`, no ar — aposta 2 ✅ realizada) + assessment-brain (`abba scout`) | Site vivo (ainda não aberto ao público — R4/R16); CLI funcional | O documento (32–60 págs, gerado em <5 min) abre com o [Mapa de Vazamento](../03-comercial/mapa-de-vazamento.md) (faixa em R$); apresentação sempre ao vivo; exige provedor de busca real configurado ({{PEDRO VERIFICAR}}) |
