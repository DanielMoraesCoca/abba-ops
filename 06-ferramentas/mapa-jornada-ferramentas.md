...
| 08 Capacitação | Portal (trilhas, desafios, Bússola, Iris, admin) + presencial | Conteúdo FINAL; 27 aulas NO portal | Materiais completos ([catálogo](../08-materiais/README.md)): roteiros, kit de Kickoff, cards, prompts, desafios, lições CrewAI · as trilhas já estão carregadas no portal (o preflight audita) · falta: gravar vídeos, imprimir cards · níveis oficiais propagados (P7 ✅) |
