...
- **Arquivos datados:** `AAAA-MM-DD Documento - Cliente` (ex.: `2026-08-14 Proposta Avaliação - ExemploCorp.pdf`).
  Hífen, nunca travessão: o nome do arquivo é texto da ABBA e chega ao
  cliente na aba do navegador dele. Os arquivos JÁ no Drive ficam como
  estão; renomear em lote é decisão do sócio, não requisito desta regra
