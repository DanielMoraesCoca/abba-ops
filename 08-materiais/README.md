...
- **Sem travessão (—) em material oficial** (decisão do sócio, 2026-09-01): no lugar: dois-pontos, ponto ou vírgula. Desde 2026-09-02 vale também para os documentos internos vivos (históricos e append-only preservados); o separador tipográfico `·` continua permitido
