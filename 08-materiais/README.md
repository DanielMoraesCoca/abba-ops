...
| Modelo do Assessment gratuito (degustação, DOCX → PDF) | estágio 02 | ✅ [`modelos/analise-abba-modelo.docx`](modelos/analise-abba-modelo.docx) |
...
| **Apresentação enviável** (PDF A4, 3 págs — **o documento-padrão, §0**: a história em ordem, jornada 1–7 em "o quê · por quê · como", **sem preços**, logos Microsoft/CrewAI; termina no CTA do Assessment gratuito; **é o que se manda quando o prospect pede "conteúdo antes da reunião"**; versão-relâmpago de 1 pág para WhatsApp: `abba-um-minuto.pdf`) | pós-ligação / pré-reunião — [ordem de envio no kit](../03-comercial/kit-de-presenca.md) | ✅ [`modelos/abba-apresentacao.pdf`](modelos/abba-apresentacao.pdf) (fonte: `.pptx` ao lado) |
