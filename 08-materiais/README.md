...
| **Deck para O Conselho** (PDF 16:9, 12 slides + fonte HTML editável — no padrão editorial da casa: navy + dourado sobre BRANCO, serifada Cormorant, versaletes dourados, filetes, sem cartões, uma ideia por slide; fundadores com a ponte CrewAI referenciada em fonte pública; sem preços, sem clientes inventados; fotos dos sócios marcadas [FOTO]) | palestra/envio ao grupo O Conselho — **antes de enviar: aval do Pedro na menção ao irmão (João Moura/CrewAI) e fotos reais** | ✅ [`modelos/abba-deck-conselho.pdf`](modelos/abba-deck-conselho.pdf) |
