...
| Material | Uso | Status |
|---|---|---|
| Deck institucional (PPTX+PDF, **12 slides — refeito na V5 (2026-08-31) pelo gerador**: capa navy, o problema (RAND/METR/DORA), a tese dos 70%, o Mapa, o Programa em 3 fases, o Portão da Prova, dentro da construção, depois do ano 1 (Assinatura + Exame Anual), Conselheiro, por que terceiro, raízes, CTA — **sem preços**) | 2ª reunião em diante — apresentação ao vivo | ✅ [`modelos/abba-deck-institucional.pptx`](modelos/abba-deck-institucional.pptx) |
...
| **Deck do Programa** (PPTX+PDF, 8 slides, padrão §0 — capa navy, o Mapa, fase 1, o Portão da Prova, fases 2–3, depois do ano, o que fica com você; **com as fotos reais dos entregáveis** (empresa preservada); **sem preços**) | aprofundamento do Programa: ao vivo na conversa, ou enviar DEPOIS dela — nunca como primeiro contato | ✅ [`modelos/deck-programa.pptx`](modelos/deck-programa.pptx) (gerador, V5) |
| **Deck do Conselheiro** (PPTX+PDF, 6 slides, padrão §0 — para quem já tem IA rodando; com o parecer de arbitragem real; **sem preços**) | conversa do Conselheiro — substitui o `servico-7-conselheiro-deck` | ✅ [`modelos/deck-conselheiro.pptx`](modelos/deck-conselheiro.pptx) (gerador, V5) |
