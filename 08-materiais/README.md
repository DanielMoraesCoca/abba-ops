...
| Vídeos das trilhas (pelos roteiros VIGENTES, nunca o Módulo 2.1/4D revogado, ver §Módulo 2.1 acima) | portal | 27/27 roteiros prontos (04/09: base comum 8, aplicação no trabalho 11, Formação de Campeão 8); gravar em lotes |
