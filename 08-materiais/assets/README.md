...
> entregáveis só existiriam dentro de binários deletados. O gerador
> (`../gerador/`) referencia tudo daqui por caminho relativo.

| Arquivo | Origem (deck · slide) | O que é |
|---|---|---|
| `marca/logo-microsoft.png` | abba-apresentacao · pág. 3 | Logo oficial de parceiro |
| `marca/logo-crewai.png` | abba-apresentacao · pág. 3 | Logo oficial de parceiro |
| `fotos/mapa-de-vazamento--pagina-real.jpg` | servico-1 · slide 2 | Página real do Mapa de Vazamento (anonimizada) |
| `fotos/analise-radar-maturidade.jpg` | servico-1 · slide 5 | Página de análise real com radar de maturidade (recortada) |
