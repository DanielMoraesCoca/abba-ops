...
- `rotas/` — **estudo de marca em 4 rotas (agência)**: monograma A·, nascente geométrica, o selo e "a herança do nome" (selo com o raio da fonte; variante aleph) — cada uma com racional e mockups (avatar, cartão, timbrado, tela). `abba-estudo-marca.pdf` é a apresentação de 6 páginas para os sócios decidirem; recomendação registrada: wordmark + selo da Rota 4 "o raio" + monograma; aleph como variação de colecionador. Pendente: escolha dos sócios.
