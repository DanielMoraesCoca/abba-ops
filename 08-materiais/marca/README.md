...
- `rotas/` — **estudo de marca em 3 rotas (agência)**: monograma A·, nascente geométrica e o selo — cada uma com racional e mockups (avatar, cartão, timbrado, tela). `abba-estudo-marca.pdf` é a apresentação de 6 páginas para os sócios decidirem; recomendação registrada: sistema wordmark + selo + monograma. Pendente: escolha dos sócios.
