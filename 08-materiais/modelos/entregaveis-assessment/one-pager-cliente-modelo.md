...
## AI maturity at a glance

**Overall: level 3 of 5 — Structured** *(from 6 of 6 pillars with a reading)*

- ●●●○○ **Strategy & Future-Readiness** — Structured
- ●●●○○ **Operations & Decisions** — Structured
- ●●○○○ **Technology & Integration** — Aware
- ●●○○○ **People & Knowledge** — Aware
- ●●●○○ **Data & Governance** — Structured
- ●●●○○ **Value & Customer** — Structured

*Derived from this assessment's 25-dimension analysis — not an industry benchmark. The full radar is in the visual annex.*
...
### Top bleeds, ranked by annual cost
...
*Larger investments that change what you can do — not just what you cost.*
...
## 3. What changes for your team

*AI is not a layoff plan. It is a leverage plan. Here is what shifts for the key roles in your company.*
...
*Order matters. Never start with the eye — start with the elbow.*
...
**How we will prove it worked:** Horas de reunião por semana e número de divergências abertas na segunda-feira. Linha de base coletada nas 3 semanas antes do piloto.

**What gets unlocked next:** Reduz também a latência de decisão, porque a divergência deixa de ser descoberta na reunião.
...
**How we will prove it worked:** Horas de digitação por semana e defasagem do ERP em horas.

**What gets unlocked next:** É pré-requisito de qualidade de dado para a reconciliação e para o sequenciamento.
...
**How we will prove it worked:** Incidentes por trimestre e tempo até detectar uma quebra.

**What gets unlocked next:** Sustenta a reconciliação: sem esta ponte, o agente reconcilia dado que vai quebrar de novo.

---

## 5. What only your people can do

*The hardest part of an AI strategy is naming what AI cannot replace. These are the moments where your humans create the value AI can't.*
...
*This is a draft prepared for Nortex Componentes (empresa fictícia) by ABBA. Edit before presenting.*
