...
## What They Said, Side by Side

*1 contradiction(s) detected mechanically across stakeholder levels — no model judgement involved, both quotes are verbatim from the ingested material. Each one is a question for the next meeting.*

### negation vs evidence — high · 2 level(s) apart

- **ceo_board** (entrevista-diretor-industrial.md): "Se precisar mudar processo, o PCP resolve"
- **dept_head** (entrevista-pcp.md): "Mudança de processo não passa sem o aval da engenharia"

> **Ask next:** Uma fonte nega algo que outra fonte descreve. Isso costuma revelar um ponto cego, ou a diferença entre a norma e a prática.


### Where Information Breaks Between Levels

*The same detections, aggregated by hierarchy boundary. A hot boundary is not two people who dislike each other: it is a handoff the process forces and does not support. The fix is almost never the relationship; it is redesigning the flow so the handoff stops depending on it.*

- **ceo_board ↔ dept_head** — 1 contradiction(s), 1 high. Mostly negation vs evidence.
  - e.g. "Se precisar mudar processo, o PCP resolve" vs "Mudança de processo não passa sem o aval da engenharia"
...
*Generated by ABBA Assessment Brain on 2026-08-31. Model: claude-haiku. Cost: $3.18.*
